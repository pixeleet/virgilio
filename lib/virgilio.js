...
var Virgilio = function(options) {
    ...
    //Virgilio sends all communications over this stream. Replace it to
    //implement for instance communication between instances or queues.
...
Virgilio.prototype.loadModule$ = function(module) {
    ...
    if (this.loadedModules$[moduleName]) {
        ...
        this.log$.trace('Module `%s` already loaded.', moduleName);
        return this;
    } else if (moduleName) {
