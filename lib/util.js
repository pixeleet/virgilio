...
//**getFunctionName** gets the name of a function and returns an empty string
...
//**stringifyFunction** returns the complete function as a string.
function stringifyFunction(func) {
    return func.toString();
}

//**parseFunction** evals a stringified function in a vm, then returns
//a function reference.
var vm = require('vm');
function parseFunction(funcString) {
    return vm.runInNewContext('func=' + funcString);
}

module.exports.getFunctionName = getFunctionName;
module.exports.extend = extend;
module.exports.createCustomError = createCustomError;
module.exports.stringifyFunction = stringifyFunction;
